...
{
    $message_log["user"] = is_null($user) ? NULL : array("id" => $user["id"], "name" => $user["username"]); //name => username || need to change to be name fields exact of name to display, depend on name fields in table of user type
